...
#
# Set project version from git tags. Function export variables
# to parent scope described below:
#
# PROJECT_VERSION
...
FUNCTION(PROJECT_VERSION_FROM_GIT)
	...
	IF(NOT GIT_COMMIT_RES)
		...
		SET(${PROJECT_NAME}_GIT_COMMIT "${PROJECT_GIT_COMMIT}"
			PARENT_SCOPE)
		...
		IF(NOT GIT_TAG_RES AND GIT_TAG_STDOUT MATCHES
			"${GIT_TAG_MATCH}")
		...
		ELSE()
			...
			IF(GIT_COUNT_RES)
				MESSAGE(FATAL_ERROR "Unexpected error from"
					" '${GIT_EXECUTABLE} rev-list --all"
					" --count'\n"
					" ${GIT_COUNT_STDERR}")
			ENDIF()
	...
	MESSAGE(STATUS "Set version of ${PROJECT_NAME} to"
		" ${PROJECT_VERSION}")
ENDFUNCTION()

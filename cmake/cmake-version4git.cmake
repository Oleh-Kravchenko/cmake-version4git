...
FUNCTION(PROJECT_VERSION_FROM_GIT)
	...
	IF(GIT_STDOUT MATCHES "v([0-9]|[1-9][0-9]*)\\.([0-9]|[1-9][0-9]*)(-([1-9][0-9]*)-g[0-9a-f]+)?")
	...
	ELSE()
		MESSAGE(STATUS
			...
			"Project should be tagged using 'vX.Y' pattern"
			" (e.g. 'v0.1')")
		...
		IF(GIT_RES)
			MESSAGE(STATUS
				"There's no Git repository or it's empty,"
				" using version 0.0.0")
		...
		ELSE()
			SET(PROJECT_VERSION_MAJOR 0)
			SET(PROJECT_VERSION_MINOR 0)
			SET(PROJECT_VERSION_PATCH ${GIT_STDOUT})
		ENDIF()
	ENDIF()
